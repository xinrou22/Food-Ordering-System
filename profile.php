...
{
	if(empty($_POST['fname']||$_POST['password']==''||$_POST['contact']==''||$_POST['address']==''))
		{	
			$message = 'All fields Must be Fillup!';
		...
		$message = "Invalid phone number!";
			...
			$sql = "UPDATE users SET fname='$_POST[fname]',contact='$_POST[contact]',address='$_POST[address]' where user_id='{$_SESSION['user_id']}'";  
			mysqli_query($db, $sql); 
...
<section>
	<div class="wrapper">
    <p class="login-text" style="font-size: 3rem; font-weight: 800; color: #782375" align="center">Profile</p>
    ...
    <form action="" method="POST">
	  ...
	  <div class="inputfield">
          ...
          <input readonly type="text" class="input" name="email" placeholder="Enter your email address" value="<?php echo $row['email']; ?>" style="background-color:#E7E7E7;">
       </div> 
		
				
       <div class="inputfield">
          <label>Full Name</label>
          <input readonly type="text" class="input" name="fname" placeholder="Enter your full name" value="<?php echo $row['fname']; ?>" style="background-color:#E7E7E7;">
       </div> 
 ...
 <?php
		...
		<p class="change-pass-text">Want to change your password? <a href="change-pass.php">Click Here</a> !</p>
		</form>
	</div>
</section>
